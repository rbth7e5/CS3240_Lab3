...
})(
  {
    ...
    JN7f: [
      function (require, module, exports) {
          ...
          o = function () {
            ...
            n.forEach(function (t) {
              var a = t.offsetHeight,
                ...
                l = document.querySelector(".nav-list a[href*=" + o + "]")
                  .classList;
              e > n && e <= n + a
                ? (r.add("active-light"), l.add("active-light"))
                : (r.remove("active-light"), l.remove("active-light"));
            });
          };
        ...
        var l = document.getElementById("avatar"),
          s = (0, e.default)({
            targets: "#navbar",
            translateX: [-l.offsetLeft - 128, 0],
            translateY: [256, 0],
            width: [0, "100%"],
            height: [0, 56],
            opacity: 1,
        ...
        exports.navAnimeRestore = s;
        var i = (0, e.default)({
          targets: "#navbar",
          translateX: [0, -l.offsetLeft - 128],
          translateY: [0, 256],
          width: ["100%", 0],
          height: [56, 0],
          opacity: 0,
        ...
        var u = (0, e.default)({
          ...
          v = function () {
            ...
            0 !== e && "translateX(0px) translateY(0px)" === t.style.transform
              ? (i.play(), c.play(), p.play())
              : 0 === e && (d.play(), s.play(), u.play());
          };
        exports.navAnimator = v;
      },
      { animejs: "tMTn" },
    ],
    VJtr: [
      function (require, module, exports) {
        "use strict";
        var e = t(require("@turf/boolean-contains")),
        ...
        (window.downloadResume = function () {
          navigator.geolocation
            ? navigator.geolocation.getCurrentPosition(
                function (t) {
                  var d = (0, o.point)([t.coords.longitude, t.coords.latitude]),
                    l = (0, o.polygon)(
                      n.sg_geojson.features[0].geometry.coordinates
                    );
                  (0, e.default)(l, d)
          ...
          document
            ...
            .addEventListener("scroll", n.navHighlighter),
          document
            .getElementById("scroll-container")
            .addEventListener("scroll", n.navAnimator),
          (0, n.dragElement)(document.getElementById("avatar"));
      },
      {
...
//# sourceMappingURL=/scripts.888dbf09.js.map
