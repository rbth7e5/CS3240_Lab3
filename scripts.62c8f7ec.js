...
})(
  {
    ...
    JN7f: [
      function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: !0 }),
          (exports.navHighlighter = exports.sg_geojson = void 0);
        var e = {
        ...
        var t = function () {
          var e = document.querySelectorAll("section[id]"),
            t = document.getElementById("scroll-container").scrollTop;
          e.forEach(function (e) {
            var o = e.offsetHeight,
              r = e.offsetTop - 50,
              i = e.getAttribute("id"),
              s = document.querySelector(".nav a[href*=" + i + "]").classList;
            t > r && t <= r + o
              ? s.add("active-light")
              : s.remove("active-light");
          });
        };
        exports.navHighlighter = t;
      },
      {},
    ],
    VJtr: [
...
//# sourceMappingURL=/scripts.62c8f7ec.js.map
