...
window.addEventListener("load", function () {
  ...
  this.setTimeout(function () {
    ...
    loader.remove();
    _this.document.body.className = "background";
    _this.document.getElementById("scroll-container").style.visibility = "visible";
    _this.document.getElementById("avatar").style.visibility = "visible";
  }, 1000);
});
},{"./consts":"js/consts.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
